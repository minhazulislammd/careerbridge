...
<head>
    ...
    <title>Finding Seekers Instant</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@100;400;500;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://unpkg.com/leaflet@1.7.1/dist/leaflet.css" />
    <link rel="stylesheet" href="https://unpkg.com/leaflet-control-geocoder/dist/Control.Geocoder.css" />
    <link rel="stylesheet" href="find_seekers_for_instant_job.css">
    <style>
        #map {
            margin-top: 20px;
            height: 400px;
...
<script>
        ...
        seekers.forEach(seeker => {
            ...
            card.innerHTML = `
                <div class="seekers-info">
                    ...
                    <h3>Name: ${seeker.firstname} ${seeker.lastname}</h3>
                    <p>Bio: ${seeker.bio}</p>
                    <p>Skills: </p>
                </div>
                <div class="seekers-info-lower-part">
                    <span class="client-rating">${seeker.rating}</span>
                    <span class="client-location">${seeker.location}</span>
                </div>
            `;
    ...
    document.addEventListener('DOMContentLoaded', addSeekers);
</script>
