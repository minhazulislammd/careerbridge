    ...
    <div class="page">
        ...
        <section id="hero">
                <div class="hero-content">
                    <h1>Find out candidates from job postings</h1>
      ...
      <div class="image">
        <img src="logo/job11.png" style="margin-bottom: 30px;">
      </div>
      <div class="text">
        <h1>Post a job and hire a pro</h1>
        <h5 style="color: #566573;">Learn about working with talent or explore your specific hiring needs.</h5>
      </div>
    </div>
            </section>
        ...
        <h1 >Post the details about jobs</h1>
        <h5 style="color: #566573;">Get a snapshot of the candidates you’ve hired, their start dates, and job details.</h5>
      </div>
      <div class="image1">
        <img src="logo/job12.png" style="border-radius: 25px; margin-left:70px;">
      </div>
            ...
            <section id="hero">
                <div class="hero-content">
                    <h1 style="color: #566573;">Stay in touch with your hires for ongoing support, feedback, and queries.</h1>
                    <a href="clientOrSeeker.php" class="start_button">Post Jobs</a>
                </div>
            </section>
        </div>
    </div>
